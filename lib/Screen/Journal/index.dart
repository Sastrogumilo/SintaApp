...
import 'package:sinta_app/Screen/Journal/List/list.dart';
...
import 'package:sinta_app/Screen/Journal/List/listHasil.dart';

class ScreenLayoutJournal extends StatefulWidget {
  const ScreenLayoutJournal({Key key, this.animationController}) : super(key: key);

  final AnimationController animationController;
  @override
  ScreenLayoutJournalState createState() => new ScreenLayoutJournalState();
}

class ScreenLayoutJournalState extends State<ScreenLayoutJournal> with TickerProviderStateMixin{
  ...
  Widget getHasilCariJournal(nama) {
    return Padding(
      padding: const EdgeInsets.only(top: 8.0, left: 18, right: 16),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
  ...
  void moveToK() {
    Navigator.push<dynamic>(
      ...
      MaterialPageRoute<dynamic>(
        builder: (BuildContext context) => JournalInfoScreen(),
      ),
    );
  }
  void moveToHasil() {
    Navigator.push<dynamic>(
      context,
      MaterialPageRoute<dynamic>(
        builder: (BuildContext context) => HasilSearchJournal(),
      ),
    );
  }
